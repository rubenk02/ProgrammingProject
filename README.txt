...
11) NOTE ON SUBMISSION SIZE:
Due to the 20 MB size limit for the ZIP submission, some reproducible files
(e.g. raw scraped data and generated plots) are not included in the ZIP.
These files can be regenerated by running the scraping scripts and analysis notebook
as described in this README, or accessed directly in the project GitHub repository.